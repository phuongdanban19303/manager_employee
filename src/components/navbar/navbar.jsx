  ...
  return (
    <div className="w-20 lg:w-24 bg-[#0a2540] h-full flex flex-col shrink-0 items-center py-8 shadow-2xl z-20 border-r border-white/5">
      <div className="mb-12">
        <Link
          to="/"
          className="w-12 h-12 bg-blue-600 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-blue-900/40 hover:rotate-12 transition-all group"
        >
      ...
      <div className="flex flex-col gap-6 mt-auto">
        <button
          title="Cài đặt"
          className="w-14 h-14 flex items-center justify-center text-slate-500 hover:text-white transition-colors"
        >
          <FaCog size={20} />
        </button>
        <button
